...
function debug_log($message) {
    error_log("[GET_COMPLETED_TRIPS_DEBUG] " . $message);
}
...
try {
    ...
    // Get completed trips
    debug_log("Getting completed trips");
    try {
        $stmt = $db->prepare("
            SELECT 
                b.booking_id,
        ...
        debug_log("Found " . count($trips) . " completed trips");
        ...
        debug_log("Database error getting completed trips: " . $e->getMessage());
        throw $e;
    }
